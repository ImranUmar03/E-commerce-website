    ...
    <div>
      <div className="container pt-16 pb-16 grid-cols-2">
        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-4">
          <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:0">
            <div className="text-center felx flex-col item-center gap-1">
              <Image
                ...
                height={80}
              />
              <h2 className="font-black text-gray-500 text-[20px]">Elsa Doe</h2>
