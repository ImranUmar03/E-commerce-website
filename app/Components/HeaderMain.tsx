    ...
    <div>
      <div className="border-b  border-gray-200 py-6">
        <div className="container sm:flex justify-between items-center">
          <div className="font-bold text-4xl text-center pb-4 sm:pb-0 text-blackish ml-10">
            Logo
          </div>

          <div className="w-full sm:w[300px] md:w-[70%] relative">
            <input
              className="border-gray-200 border p-2 px-4 rounder-lg w-full"
              type="text"
          ...
          <div className="hidden lg:flex gap-4 text-gray-500 text-[12px] ">
            <BiUser
              size={30}
